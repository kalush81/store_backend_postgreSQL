...
class ProductStore {
    ...
    create(p) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const conn = yield index_1.default.connect();
                const sql = "INSERT INTO clothes_schema.products (name, description, quantity, price, category) VALUES($1, $2, $3, $4, $5) RETURNING *;";
                const result = yield conn.query(sql, [
                    p.name,
                    p.description,
                    p.quantity,
    ...
    delete(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const conn = yield index_1.default.connect();
                const sql = "DELETE FROM clothes_schema.products WHERE id = $1 RETURNING id;";
                const result = yield conn.query(sql, [id]);
                conn.release();
